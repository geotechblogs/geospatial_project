...
from geoproject.services.locations import create_location_service, get_all_locations_service, get_location_by_id_service, update_location_service, delete_location_service
from geoproject.models.locations import LocationCreate, LocationUpdate, LocationResponse, AllLocations
...
def update_location(location_id: UUID, location: LocationUpdate, db: Session = Depends(get_session)):
